...
input.addEventListener('keyup', function () {
	...
	$(".outputarea").append('<button type="button" value="'+word+'" class="flat-button" onclick="showDefinitions(\''+word+'\');">'+word+' : '+statistics[word]+'</button>');
    }
});
...
button.addEventListener('click', function () {
    ...
    $.post("/parse", textToParse,
	   function(data,status){
		   ...
		   $(".outputarea").append('<button type="button" value="'+word+'" class="flat-button" onclick="showDefinitions(\''+word+'\');">'+word+' : '+results[word]+'</button>');
	       }
	   });
