...
func PostHandler(w http.ResponseWriter, r *http.Request){
	...
	for rows.Next() {
		...
		if k_ele_id.Valid && word_definitions[kanji] == nil {
			word_definitions[kanji] = NewDictionaryResult()
		}

		if sense_id.Valid {
			sense_id_value = strconv.FormatInt(sense_id.Int64, 10)
			if word_definitions[kanji].Sense[sense_id_value] == nil {
				word_definitions[kanji].Sense[sense_id_value] = &Senseinfo{}
			}
		}

		if r_ele_val.Valid && word_definitions[kanji].R_ele[r_ele_val.String] == nil {
			word_definitions[kanji].R_ele[r_ele_val.String] = &Releinfo{}
		}
		switch {
		case ke_inf_id.Valid:
			word_definitions[kanji].K_ele.Ke_inf = append(word_definitions[kanji].K_ele.Ke_inf, ke_inf_val.Int64)
		case ke_pri_id.Valid:
			word_definitions[kanji].K_ele.Ke_pri = append(word_definitions[kanji].K_ele.Ke_pri, ke_pri_val.String)
		case re_restr_id.Valid:
			word_definitions[kanji].R_ele[r_ele_val.String].Re_restr = append(word_definitions[kanji].R_ele[r_ele_val.String].Re_restr, re_restr_val.String)
		case re_inf_id.Valid:
			word_definitions[kanji].R_ele[r_ele_val.String].Re_inf = append(word_definitions[kanji].R_ele[r_ele_val.String].Re_inf, re_inf_val.Int64)
		case re_pri_id.Valid:
			word_definitions[kanji].R_ele[r_ele_val.String].Re_pri = append(word_definitions[kanji].R_ele[r_ele_val.String].Re_pri, re_pri_val.String)
		case stagk_val.Valid:
			word_definitions[kanji].Sense[sense_id_value].Stagk = append(word_definitions[kanji].Sense[sense_id_value].Stagk, stagk_val.String)
		case stagr_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Stagr = append(word_definitions[kanji].Sense[sense_id_value].Stagr, stagr_val.String)
		case pos_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Pos = append(word_definitions[kanji].Sense[sense_id_value].Pos, pos_val.Int64)
		case xref_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Xref = append(word_definitions[kanji].Sense[sense_id_value].Xref, xref_val.String)
		case ant_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Ant = append(word_definitions[kanji].Sense[sense_id_value].Ant, ant_val.String)
		case field_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Field = append(word_definitions[kanji].Sense[sense_id_value].Field, field_val.Int64)
		case misc_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Misc = append(word_definitions[kanji].Sense[sense_id_value].Misc, misc_val.Int64)
		case s_inf_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].S_inf = append(word_definitions[kanji].Sense[sense_id_value].S_inf, s_inf_val.String)
		case gloss_id.Valid:
			word_definitions[kanji].Sense[sense_id_value].Gloss = append(word_definitions[kanji].Sense[sense_id_value].Gloss, gloss_val.String)
